...
void RobotContainer::ConfigureBindings() {
  ...
  frc2::Trigger{[this]() { return secondaryController.GetXButton(); }}
      .OnTrue(frc2::cmd::RunOnce([this] {
        m_elevatorSubsystem.SetSuperState(
            m_elevatorSubsystem.currSuperState == ElevatorSubsystem::SuperStates::coral ? ElevatorSubsystem::SuperStates::algae : ElevatorSubsystem::SuperStates::coral);
      }));
}